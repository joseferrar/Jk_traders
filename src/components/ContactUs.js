                    ...
                    <div class="contact-detail position-relative p-3">
                        <div class="row g-5 mb-5 justify-content-center">
                            <div class="col-xl-4 col-sm-5 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                                <div class="d-flex bg-light p-3 align-items-center rounded">
                                    <div class="flex-shrink-0 btn-square my-button rounded-circle" style={{width: '64px', height: '64px'}}>
                                        <i class="fas fa-map-marker-alt text-white"></i>
                                    </div>
                                    <div class="ms-3">
                                        <h5 class="text-primary">Address</h5>
                                        <a href="https://goo.gl/maps/Zd4BCynmTb98ivUJ6" target="_blank" class="h5" style={{wordBreak: 'break-word', fontSize: 18}}>No. 5D/484, NGO Colony, Tuticorin - 628005.</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                                <div class="d-flex bg-light p-3 align-items-center rounded">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <a class="h5" href="tel:+919080810258" target="_blank" style={{wordBreak: 'break-word', fontSize: 18}}>+91 90808 10258</a><br />
                                        <a class="h5" href="tel:+918123360699" target="_blank" style={{wordBreak: 'break-word', fontSize: 18}}>+91 81233 60699</a><br />
                                        <a class="h5" href="tel:+04613588818" target="_blank" style={{wordBreak: 'break-word', fontSize: 18}}>0461 358 8818</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                                <div class="d-flex bg-light p-3 align-items-center rounded">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <a class="h5" href="mailto:info@example.com" target="_blank" style={{wordBreak: 'break-word', fontSize: 18}}>jksgypsumplaster@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
